...
export default function CookiesPolicy({
  ...
  validConsentPeriod = "šest mesíců",
  ...
  return (
    <section id="cookies" className="text-formatter">
      ...
      <p>
        ...
        {responsibleSubject} se sídlem {subjectAdress}, IČ:{" "}
      ...
      {preferencesCookies && (
        <>
          <h3>Preferenční soubory cookies</h3>
          <p>
            Umožňují webové stránce poskytovat lepší funkcionalitu a
            personalizaci na základě vaší vzájemné interakce. Mohou být
            nastaveny námi nebo poskytovateli třetích stran, jejichž služby jsme
            na naše stránky přidali.
          </p>
        </>
      )}
      ...
      {statisticCookies && (
        <>
          ...
          <p>
            Umožňují nám sledovat analytiku počítáním návštěv a provozních
            zdrojů, abychom mohli měřit a zlepšovat výkon našeho webu. Mohou být
            nastaveny námi nebo poskytovateli třetích stran (např. Google,
            Seznam, Amazon, Vercel, atd.), aby nám pomohly zjistit, které
            stránky, příspěvky nebo videa jsou nejvíce a nejméně populární a jak
            se návštěvníci na webových stránkách pohybují.
          </p>
        </>
      )}
      ...
      {marketingCookies && (
        <>
          ...
          <p>
            Jsou nastaveny službami sociálních médií (např. Meta, Twitter),
            které jsme přidali na web, abychom vám umožnili sdílet náš obsah se
            svými přáteli a sítěmi. Tyto soubory cookies jsou schopny sledovat
            váš prohlížeč na jiných webových stránkách a sestavovat profil
            vašich zájmů. To může ovlivnit obsah a zprávy, které vidíte na
            jiných webových stránkách, které navštěvujete.
          </p>
        </>
      )}
      ...
      {thirdPartyCookies && (
        <>
          ...
          <p>
            Jsou nastaveny službami a obsahem od externích poskytovatelů (např.
            Google, Youtube, Meta, Twitter), který se na našem webu nachází. Aby
            se vám takový obsah třetích stran zobrazoval, musíte nejprve
            přijmout jejich podmínky. To zahrnuje i jejich politiku týkající se
            souborů cookies.
          </p>
          <p>
            Nad soubory cookies těchto třetích stran nemáme žádnou kontrolu ani
            za ně neneseme žádnou odpovědnost. Poskytovatelé mohou kdykoli
            změnit podmínky, účel, způsob používání souborů cookies atd.
          </p>
        </>
      )}
      ...
      <p>
        ...
        na {validConsentPeriod}, pokud je před vypršením platnosti neodstraníte.
        Poté budete při další návštěvě webu opětovně vyzváni k potvrzení
        cookies. Relační cookies naopak vyprší na konci vaší webové relace, když
        se webový prohlížeč zavře.
      </p>
